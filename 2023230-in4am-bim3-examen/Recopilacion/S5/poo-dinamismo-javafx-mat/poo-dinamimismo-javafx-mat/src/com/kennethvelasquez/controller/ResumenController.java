...
public class ResumenController {
    ...
    public void verInformacion(){
        Persona personaSeleccionada = this.resumenView.getTblPersonas().getSelectionModel().getSelectedItem();
        
//        SelectionModel modeloTabla = this.resumenView.getTblPersonas().getSelectionModel();
//        Persona objetoSeleccionado = (Persona) modeloTabla.getSelectedItem();

        if( personaSeleccionada == null){
            JOptionPane.showMessageDialog(null, "NO HA SELECCIONADO REGISTROS");
        }else{
